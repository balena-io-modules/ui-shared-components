...
<table style={{ width: '100%', borderCollapse: 'collapse' }}>
	<tbody>
		...
		<tr>
			...
			<td>TODO find a more suitable name for this role</td>
		</tr>
		<tr>
...
<ColorTable>
	<ColorRow token={color.bg.info} description="Use to highlight a primary, stable state or for a message providing additional details." />
	<ColorRow token={color.bg.info.strong} description="Use to emphasize a primary, stable state or for a message providing additional details." />
	<ColorRow token={color.bg.success} description="Use to highlight a positive, successful message." />
	<ColorRow token={color.bg.success.strong} description="Use to emphasize a positive, successful message." />
	<ColorRow token={color.bg.warning} description="Use to highlight a message that requires the user's attention." />
	<ColorRow token={color.bg.warning.strong} description="Use to emphasize a message that requires the user's attention." />
	<ColorRow token={color.bg.danger} description="Use to highlight an error, blocked status, or permanent change." />
	<ColorRow token={color.bg.danger.strong} description="Use to emphasize an error, blocked status, or permanent change." />
</ColorTable>
...
<ColorTable>
	<ColorRow token={color.border} description="Use to define the edges of an element, for example, a card." />
	<ColorRow token={color.border.subtle} description="Use to define the separation between items within an element." />
	<ColorRow token={color.border.strong} description="Use to emphasize the edges of an element, for example, a card." />
	<ColorRow token={color.border.accent} description="Use to highlight an element to stand out in the UI with no additional context." />
	<ColorRow token={color.border.accent.strong} description="Use to emphasize an element to stand out in the UI with no additional context." />
</ColorTable>

#### Roles

<ColorTable>
	<ColorRow token={color.border.info} description="Use to highlight a primary, stable state or for a message providing additional details." />
	<ColorRow token={color.border.info.strong} description="Use to emphasize a primary, stable state or for a message providing additional details." />
	<ColorRow token={color.border.success} description="Use to highlight a positive, successful message." />
	<ColorRow token={color.border.success.strong} description="Use to emphasize a positive, successful message." />
	<ColorRow token={color.border.warning} description="Use to highlight a message that requires the user's attention." />
	<ColorRow token={color.border.warning.strong} description="Use to emphasize a message that requires the user's attention." />
	<ColorRow token={color.border.danger} description="Use to highlight an error, blocked status or permanent change." />
	<ColorRow token={color.border.danger.strong} description="Use to emphasize an error, blocked status or permanent change." />
</ColorTable>
...
<ColorTable>
	<ColorRow token={color.icon} description="The default color for icons." />
	<ColorRow token={color.icon.subtle} description="Use when the icon needs to be less prominent. Can be used alongside a different text color." />
	<ColorRow token={color.icon.subtlest} description="Use for icons that need to blend into the background, such as placeholders." />
	<ColorRow token={color.icon.inverse} description="Use when the icon is on an Inverted background." />
	<ColorRow token={color.icon.accent} description="Use to highlight an icon to stand out in the UI with no additional context." />
</ColorTable>

#### Roles

<ColorTable>
	<ColorRow token={color.icon.info} description="Use to highlight a primary, stable state or to provide additional details." />
	<ColorRow token={color.icon.success} description="Use to highlight a positive, successful icon." />
	<ColorRow token={color.icon.warning} description="Use to highlight an icon that requires the user's attention." />
	<ColorRow token={color.icon.danger} description="Use to highlight an error, blocked status, or permanent change." />
</ColorTable>
...
<ColorTable>
	<ColorRow token={color.status.inactive} description="Use to show a state which isn't currently active." />
	<ColorRow token={color.status.success} description= 'Use to show a positive, successful state.' />
	<ColorRow token={color.status.warning} description="Use to show a state that requires the user's attention." />
	<ColorRow token={color.status.danger} description= 'Use to show an error or blocked state.' />
	<ColorRow token={color.status.info} description= 'Use to highlight a neutral or primary, stable state.' />
	<ColorRow token={color.status.purple} description="Use to highlight a neutral state where 'info' is already present." />
	<ColorRow token={color.status.teal} description="Use to highlight a neutral state where 'info' and 'purple' are already present." />
</ColorTable>
