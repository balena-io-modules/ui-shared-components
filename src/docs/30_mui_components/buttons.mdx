...
<ThemeProvider theme={theme}>
	...
	<Box sx={{ display: 'flex', gap: 2, mt: 2, flexWrap: 'wrap' }}>
		<LensToggle>Default</LensToggle>
		<LensToggle color="primary">Primary</LensToggle>
		<LensToggle color="secondary">Secondary</LensToggle>
		<LensToggle color="info">Info</LensToggle>
		<LensToggle color="success">Success</LensToggle>
		<LensToggle color="warning">Warning</LensToggle>
		<LensToggle color="error">Error</LensToggle>
	</Box>
</ThemeProvider> 