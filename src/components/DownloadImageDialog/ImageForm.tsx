...
export const ImageForm = memo(function ImageForm({
	...
	const supportsSecureBoot = useMemo(() => {
		return (
			...
			semver.gte(
				model.basedOnVersion ?? model.version,
						...
						<FormControl>
							<FormLabel id="secure-boot-and-full-disk-encryption-label">
								<Stack direction="row" alignItems="center" gap={1}>
									...
									<NewChip expiryTimestamp="2026-02-01" />
								</Stack>
							</FormLabel>
							<FormControlLabel
								control={
			...
			>
				...
				<DialogContent>
					...
					<ul>
						...
						<li>
							Full Disk Encryption (FDE): All data on the disk will be encrypted
							with a unique key per device, ensuring that data extraction or
							retrieval from a powered-off device is impossible.
						</li>
						<li>
