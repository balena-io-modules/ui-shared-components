	...
	return (
		<>
			...
			>
				...
				<DialogActions>
					<ButtonWithTracking
						eventName="Go back and do not acknowledge Secure Boot and Full Disk Encryption warning"
					...
					<ButtonWithTracking
						eventName="Acknowledge Secure Boot and Full Disk Encryption warning"
