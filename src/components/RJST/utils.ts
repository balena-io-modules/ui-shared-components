...
export const getTagsDisabledReason = async <T extends RJSTBaseResource<T>>(
	selected: T[] | undefined,
	tagField: keyof T,
	checkedState: CheckedState | undefined,
	tagsSdk: RJSTTagsSdk<T>,
	t: TFunction,
) => {
...
export const rjstGetDisabledReason = <T extends RJSTBaseResource<T>>(
	selected: T[] | undefined,
	checkedState: CheckedState | undefined,
	hasOngoingAction: boolean,
