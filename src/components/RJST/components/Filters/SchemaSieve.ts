...
// This is a duplicate of RJST models/helpers isJSONSchema function.
// Ideally Filters should not have any rjst notions
const isJSONSchema = (
	value:
		| JSONSchema
...
export const createModelFilter = (
	...
	// @ts-expect-error need to improve object and array
	// operatorSlug typing and use operator slug instead of string
