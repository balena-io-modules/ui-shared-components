import type { RJSTBaseResource, RJSTRawModel } from '../schemaOps';
import { rjstDefaultPermissions } from './helpers';

export interface AugmentedSshKey extends RJSTBaseResource<AugmentedSshKey> {
	title: string;
	description: string;
	public_key: string;
	id: number;
...
export const model: RJSTRawModel<AugmentedSshKey> = {
	resource: 'sshKey',
	schema: {
		type: 'object',
	...
	permissions: {
		default: rjstDefaultPermissions,
		administrator: {
