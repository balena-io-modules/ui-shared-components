...
import { DownloadImageModal, DownloadImageModalProps } from '.';
...
const Template = (props: Omit<DownloadImageModalProps, 'open' | 'onClose'>) => {
	const [show, setShow] = useState(false);

	return (
		<>
			<Button onClick={() => setShow(true)}>Open download image modal</Button>
			<DownloadImageModal
				open={show}
...
const meta = {
	title: 'Other/DownloadImageModal',
	component: Template,
	tags: ['autodocs'],
